...
function Home() {
  return (
    <>
        ...
        <div className="container-x grid min-h-[640px] items-center py-24 lg:py-32">
          <div className="max-w-3xl">
            ...
            <div className="mt-9 flex flex-wrap gap-4">
              <Link to="/quote" className="inline-flex items-center gap-2 rounded-sm bg-[color:var(--gold)] px-7 py-3.5 text-sm font-semibold text-[color:var(--navy-deep)] transition-transform hover:scale-[1.02]">
                Request a Quote <ArrowRight className="h-4 w-4" />
              </Link>
              <Link to="/services" className="inline-flex items-center gap-2 rounded-sm border border-white/30 px-7 py-3.5 text-sm font-medium text-white backdrop-blur transition-colors hover:bg-white/10">
                Explore Services
              </Link>
            </div>
            <div className="mt-12 grid max-w-2xl grid-cols-2 gap-6 border-t border-white/15 pt-8 sm:grid-cols-4">
              {[["40+","Countries"],["20+","Years Trade"],["1,200+","Shipments"],["98%","On-Time"]].map(([k,v]) => (
                <div key={v}>
      ...
      <section className="py-24">
        <div className="container-x grid gap-16 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <Link to="/about" className="mt-9 inline-flex items-center gap-2 text-sm font-semibold text-[color:var(--navy-deep)] underline-offset-4 hover:underline">
              Learn more about us <ArrowRight className="h-4 w-4" />
            </Link>
          </div>
          <div className="relative">
            <img src={cargoShip} alt="Container ship at sunrise" className="aspect-[4/5] w-full rounded-sm object-cover shadow-[var(--shadow-elegant)]" loading="lazy" width={1024} height={1024} />
      ...
      <section className="bg-secondary/60 py-24">
        <div className="container-x">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-4 font-display text-4xl font-semibold text-[color:var(--navy-deep)] md:text-5xl">End-to-end international trade</h2>
            <p className="mt-5 text-muted-foreground">From sourcing your supplier abroad to clearing goods at the destination port — we handle every link in the chain.</p>
          </div>
      ...
      {/* GLOBAL REACH */}
      <section className="relative overflow-hidden py-28 text-white" style={{ backgroundImage: `linear-gradient(120deg, oklch(0.18 0.06 260 / 0.92), oklch(0.27 0.08 260 / 0.85)), url(${worldMap})`, backgroundSize: "cover", backgroundPosition: "center" }}>
        <div className="container-x">
          <div className="mx-auto max-w-2xl text-center">
          ...
          <div className="mt-14 grid gap-10 text-center sm:grid-cols-2 lg:grid-cols-4">
            {[["40+","Countries served"],["120+","Verified suppliers"],["15M+","USD in trade volume"],["24/7","Operations support"]].map(([k,v]) => (
              <div key={v}>
      ...
      <section className="py-24">
        <div className="container-x">
          <div className="mx-auto max-w-2xl text-center">
            ...
            <h2 className="mt-4 font-display text-4xl font-semibold text-[color:var(--navy-deep)] md:text-5xl">Trusted by importers and exporters worldwide</h2>
          </div>
      ...
      <section className="bg-secondary/60 py-24" id="certificates">
        <div className="container-x">
          ...
          <div className="mx-auto max-w-2xl text-center mb-14">
            ...
            <h2 className="mt-4 font-display text-4xl font-semibold text-[color:var(--navy-deep)] md:text-5xl">Certificates & Trade Documents</h2>
            <p className="mt-5 text-muted-foreground">We are fully capable of providing all required official certificates and trade documentation for export shipments upon request.</p>
          </div>
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4 mb-24">
            {[
              ...
              <div key={cert.title} className="flex flex-col items-center rounded-sm border border-border bg-background p-6 text-center shadow-[var(--shadow-card)] hover:shadow-[var(--shadow-elegant)] transition-shadow">
                ...
                <span className="mt-3 inline-block rounded-sm bg-[color:var(--navy-deep)] px-3 py-1 text-xs font-medium text-[color:var(--gold)]">Available on Request</span>
              </div>
            ))}
          </div>
          ...
          <div className="border-t border-border pt-20">
            <div className="mx-auto max-w-2xl text-center mb-14">
              ...
              <h2 className="mt-4 font-display text-4xl font-semibold text-[color:var(--navy-deep)] md:text-5xl">Registered & Certified</h2>
              <p className="mt-5 text-muted-foreground">Goodarzi Trading is an officially registered and certified business entity with active membership in Tehran Chamber of Commerce.</p>
            </div>
            <div className="grid grid-cols-1 gap-8 md:grid-cols-2 max-w-4xl mx-auto">
              <div className="overflow-hidden rounded-sm border border-border bg-background shadow-[var(--shadow-card)]">
                <img src="/IMG_20260702_020354_773.jpg" alt="Tehran Chamber of Commerce Membership" className="w-full h-64 object-cover object-center" />
              ...
              <div className="overflow-hidden rounded-sm border border-border bg-background shadow-[var(--shadow-card)]">
                <img src="/IMG_20260702_020642_412.jpg" alt="Trademark Registration Certificate" className="w-full h-64 object-cover object-center" />
                <div className="p-6 text-center">
      ...
      <section className="border-y border-border bg-secondary/40 py-16">
        <div className="container-x">
          <p className="text-center text-xs uppercase tracking-[0.22em] text-muted-foreground">Trusted partners &amp; affiliations</p>
          <div className="mt-8 grid grid-cols-2 items-center justify-items-center gap-8 sm:grid-cols-3 md:grid-cols-5">
            {["Bedra", "Tehran C.O.C", "IRICA", "INCOTERMS 2020", "ICC"].map((p) => (
              <div key={p} className="font-display text-lg font-semibold text-[color:var(--navy)]/60 transition-colors hover:text-[color:var(--navy-deep)]">{p}</div>
            ))}
          </div>
        </div>
      </section>
      ...
      <section className="py-24">
        <div className="container-x">
          <div className="overflow-hidden rounded-sm bg-[color:var(--navy-deep)] px-8 py-16 text-center text-white md:px-20 md:py-24">
            ...
            <h2 className="mt-4 font-display text-4xl font-semibold leading-tight md:text-5xl">Ready to move your goods across borders?</h2>
            <p className="mx-auto mt-5 max-w-xl text-white/70">Tell us about your shipment, supplier, or sourcing need — we'll respond with a tailored quote within one business day.</p>
            <div className="mt-10 flex flex-wrap justify-center gap-4">
              <Link to="/quote" className="rounded-sm bg-[color:var(--gold)] px-8 py-3.5 text-sm font-semibold text-[color:var(--navy-deep)]">Request a Quote</Link>
              <Link to="/contact" className="rounded-sm border border-white/30 px-8 py-3.5 text-sm font-medium text-white hover:bg-white/10">Contact Us</Link>
            </div>
          </div>
        </div>
      </section>
